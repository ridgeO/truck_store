...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { availability: @truck.availability, make: @truck.make, model: @truck.model, owner: @truck.owner, price: @truck.price, price: @truck.price, year: @truck.year } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { availability: @truck.availability, make: @truck.make, model: @truck.model, owner: @truck.owner, price: @truck.price, price: @truck.price, year: @truck.year } }
